This dataset is derived from threads on Stack Overflow posts. The data was
downloaded from
...
The file threads-stack-overflow-simplex-labels.txt maps each simplex to the
stack exchange post id.
